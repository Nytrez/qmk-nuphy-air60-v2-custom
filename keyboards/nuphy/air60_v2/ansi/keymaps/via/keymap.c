...
enum {
    WIN_CAPS_LAYER, // Our custom tap dance key; add any other tap dance keys to this enum 
    MAC_CAPS_LAYER,
};
...
void ql_finished_mac(tap_dance_state_t *state, void *user_data);
void ql_reset_mac(tap_dance_state_t *state, void *user_data);

void ql_finished_win(tap_dance_state_t *state, void *user_data);
void ql_reset_win(tap_dance_state_t *state, void *user_data);
...
[MAC_BASE] = LAYOUT_60_ansi(
	...
	TD(MAC_CAPS_LAYER),KC_A,   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	            KC_ENT,
...
[MAC_FN_SFT] = LAYOUT_60_ansi(
	...
	_______, 	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	            _______,
	_______,	_______,   	_______,   	RGB_TEST,  	_______,   	_______,   	_______,   	MO(6),   	RGB_SPD,	RGB_SPI,  	_______,	MO(2),  	RGB_VAI,    _______,
...
[WIN_BASE] = LAYOUT_60_ansi(
	KC_ESC, 	    KC_1,   	KC_2,   	KC_3,  		KC_4,   	KC_5,   	KC_6,   	KC_7,   	KC_8,   	KC_9,  		KC_0,   	KC_MINS,	KC_EQL, 	KC_BSPC,
	KC_TAB, 	    KC_Q,   	KC_W,   	KC_E,  		KC_R,   	KC_T,   	KC_Y,   	KC_U,   	KC_I,   	KC_O,  		KC_P,   	KC_LBRC,	KC_RBRC, 	KC_BSLS,
	TD(WIN_CAPS_LAYER),	KC_A,   KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	            KC_ENT,
	KC_LSFT,	    KC_Z,   	KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,	KC_DOT,		KC_SLSH,	KC_RSFT,	KC_UP,		KC_DEL,
...
[WIN_FN] = LAYOUT_60_ansi(
	KC_GRV, 	   KC_F1,  	KC_F2,  	KC_F3, 		KC_F4,  	KC_F5,  	KC_F6,  	KC_F7,  	KC_F8,  	KC_F9, 		KC_F10, 	KC_F11, 	KC_F12, 	_______,
	MO(5), 	        _______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	DEV_RESET,	SLEEP_MODE, BAT_SHOW,
	_______, 	    _______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	            _______,
	_______,	    _______,   	_______,   	_______,  	_______,   	_______,   	_______,   	MO(6),   	RGB_SPD,	RGB_SPI,  	_______,	MO(5),  	RGB_VAI,    _______,
	_______,	    _______,	_______,										_______, 							_______,	_______,   	RGB_MOD,	RGB_VAD,    RGB_HUI),
...
tap_dance_action_t tap_dance_actions[] = {
    [WIN_CAPS_LAYER] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, ql_finished_win, ql_reset_win),
    [MAC_CAPS_LAYER] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, ql_finished_mac, ql_reset_mac),
};
